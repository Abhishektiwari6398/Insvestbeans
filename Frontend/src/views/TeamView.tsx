            ...
            <div className="gsap-section-card relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-orange-500 to-pink-500 px-6 sm:px-10 py-10 text-white shadow-[0_30px_90px_-40px_rgba(249,115,22,0.8)]">
              ...
              <div className="relative space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  <a
                    href="tel:+917838285293"
                    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/50 px-6 py-3 font-semibold text-white/90"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      ...
                      style={{ flexShrink: 0 }}
                    >
                      <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.82a19.79 19.79 0 01-3.07-8.67A2 2 0 012 .18h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.09-1.09a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/>
                    </svg>
                    Talk to us
                  </a>
                </div>
